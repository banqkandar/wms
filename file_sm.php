                ...
                echo '
                    <div class="row jarak-form">
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><i class="material-icons md-24">expand_more</i><span class="add">Tampilkan detail data surat masuk</span></div>
                        ...
                        <button onclick="window.history.back()" class="btn blue waves-effect waves-light left"><i class="material-icons md-24">arrow_back</i> KEMBALI</button>';
