                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper deep-purple darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=pro&sub=pass"><i class="material-icons md-24">mode_edit</i> Edit Profil</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
...
?>
            ...
            <div class="row">
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper deep-purple darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#"><i class="material-icons md-24">person</i> Profil User</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="post" action="save.php">
                    ...
                    <div class="row">
                        <div class="col m12">
                            <a href="?page=pro&sub=pass" class="btn-large blue waves-effect waves-light"><i class="material-icons">mode_edit</i> EDIT PROFIL</a>
                        </div>
                    </div>
